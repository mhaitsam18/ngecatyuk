                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    ?>
                                    <img src="<?= $image ?>" class="img-thumbnail foto-preview ">
                                </div>
                                <div class="col-sm-9">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="image" name="image" onchange="previewFoto()">
...
<script type="text/javascript">
    ...
    function previewFoto() {
        const foto = document.querySelector('#image'); //ambil data inputan nya
        const imgPreview = document.querySelector('.foto-preview'); // ambil data img nya
        imgPreview.style.display = 'block'; //buat style nya menjadi block
        const oFReader = new FileReader(); //bikin konstanta OFR untuk membaca File
        oFReader.readAsDataURL(foto.files[0]); // ambil File dari inputan indeks pertama (index ke 0)

        oFReader.onload = function(oFREvent) { //onLoad OFR
            imgPreview.src = oFREvent.target.result; // Tampilkan foto
        }
    }
</script>