					...
					<div class="row no-gutters">
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<a href="<?= base_url('Transaksi/tambahKeranjang/').$row['id_produk'] ?>" class="btn btn-sm btn-primary">Tambah</a>
							</div>
						</div>
					</div>
				</div>
					...
					<tbody>
						...
						<?php foreach ($this->cart->contents() as $item): ?>
							<tr>
								...
								<td>
									<a href="<?= base_url('Transaksi/kurangKeranjang/').$item['rowid'].'/'.$item['qty'] ?>" class="badge bg-danger"><i class="fas fa-minus"></i></a>
									<?= $item['qty'] ?>
									<a href="<?= base_url('Transaksi/tambahKeranjang/').$item['id'].'/'.$item['rowid'] ?>" class="badge bg-primary"><i class="fas fa-plus"></i></a>
								</td>
							</tr>
