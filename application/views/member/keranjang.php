					...
					<?php if ($this->session->userdata('cart_checkout')): ?>
						...
						<?php foreach ($this->cart->contents() as $item): ?>
							<tr>
								...
								<td>
									<a href="<?= base_url('Member/kurangKeranjang/').$item['rowid'].'/'.$item['qty'].'/keranjang' ?>" class="badge bg-warning"><i class="fas fa-minus"></i></a>
									<a href="<?= base_url('Member/tambahKeranjang/').$item['id'].'/'.$item['rowid'].'/keranjang' ?>" class="badge bg-primary"><i class="fas fa-plus"></i></a>
									<a href="<?= base_url('Member/hapusItem/').$item['rowid'].'/keranjang' ?>" class="badge bg-danger"><i class="fas fa-trash-alt"></i></a>
								</td>
							</tr>
