							...
							<div class="col">
								<select class="form-control" name="kategori" id="kategori">
									...
									<?php foreach ($kategori as $row): ?>
										<?php if ($row['id_kategori']==$this->session->userdata('pilih_kategori')): ?>
			...
			<?php foreach ($produk as $row): ?>
				<div class="card mb-3" style="max-width: 540px;">
					<div class="row no-gutters">
						...
						<div class="col-md-8">
							<div class="card-body">
								<h4 class="card-title" style="color: #a36362;"><?= $row['nama_produk'] ?></h4>
								...
								<a href="<?= base_url('Member/tambahKeranjang/').$row['id_produk'] ?>" class="btn btn-sm btn-primary">Tambah</a>
							</div>
						</div>
					</div>
				</div>
					...
					<tbody>
						...
						<?php foreach ($this->cart->contents() as $item): ?>
							<tr>
								...
								<td>
									<a href="<?= base_url('Member/kurangKeranjang/').$item['rowid'].'/'.$item['qty'] ?>" class="badge bg-danger"><i class="fa-solid fa-minus"></i></a>
									<?= $item['qty'] ?>
									<a href="<?= base_url('Member/tambahKeranjang/').$item['id'].'/'.$item['rowid'] ?>" class="badge bg-primary"><i class="fa-solid fa-plus"></i></a>
								</td>
							</tr>
					...
					<div class="form-group">
						...
						<select class="form-control" id="id_kurir" name="id_kurir">
							...
							<?php foreach ($kurir as $row): ?>
								<option value="<?= $row['id_kurir'] ?>"><?= $row['kurir'] ?></option>
							<?php endforeach ?>
						</select>
					</div>
					<div class="form-group">
